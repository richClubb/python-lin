...
class FrameSlot(object):
    ...
    def __init__(self, ldf=None, filename=None, frame_name=None, delay=None):
        ...
        frameSlotData = self.__ldf.getFrameSlots(schedule_name=schedule_name)  # ... could be None, in which case it will return an empty table       
        self.__frameId                = frameSlotData[0]
		self.__delay                  = frameSlotData[1]
